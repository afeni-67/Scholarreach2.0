...
# Polite scraping
USER_AGENT = "Scholarreach/2.0 (+https://github.com/afeniabiodun12-ship-it/Scholarreach2.0; research discovery bot)"
REQUEST_TIMEOUT = 30
...
GITHUB_REPO = os.getenv("GITHUB_REPO", "afeniabiodun12-ship-it/Scholarreach2.0")
